...
export function FitnessDashboard() {
  ...
  const handleGeneratePlan = useCallback(async () => {
    ...
    try {
      ...
      // Start streaming a preview while the main plan generates
      ...
      const planPromise = generateHighAccuracyPlan(form);
  ...
  const currentLoading = highAccuracyLoading || aiStreaming;
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">Powered by AI and scientific research</p>
                </div>
              </div>
  ...
  if (currentLoading || highAccuracyProgress) {
    return (
      <div className="min-h-screen bg-background">
        {/* Dashboard Header */}
        <div className="border-b bg-card">
            ...
            <div className="space-y-6">
              ...
              {streamingContent && (
                <div className="mt-6 p-4 bg-muted rounded-lg">
                  <h4 className="font-medium mb-2">AI Preview:</h4>
