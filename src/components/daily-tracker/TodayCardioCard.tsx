  ...
  return (
    <Card
      ...
      className={cn(
        ...
        isCompleted
          ? 'border-0 bg-gradient-to-br from-rose-400 to-red-600 shadow-[0_35px_60px_-15px_rgba(244,63,94,0.6),inset_0_2px_20px_rgba(255,255,255,0.5)]' // Red gradient like hydration's cyan
          : isSkipped
